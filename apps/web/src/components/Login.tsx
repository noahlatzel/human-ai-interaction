...
export default function Login({ onLoginSuccess }: LoginProps) {
    ...
    const handleRegistrationChange = (field: keyof typeof registrationData) => (event: ChangeEvent<HTMLInputElement>) => {
                ...
                {showRegistration ? (
                    ...
                    <div className="space-y-6">
                        <div className="text-center">
                            <h2 className="text-2xl font-bold text-slate-900">Registriere dich</h2>
                            <p className="text-sm text-slate-500 mt-1">Erstelle dein kostenloses Konto</p>
                        </div>
                        <form onSubmit={handleRegistrationSubmit} className="space-y-5">
                            <div className="space-y-2">
                                <label className="block text-sm font-semibold text-slate-700 ml-1">Voller Name</label>
                                <input
                                    type="text"
